...
privileged aspect AspectJMLRac_cmdUi_menu_AbstractMenu28bb3e6e_bb56_4172_8741_21909b89b40d {
 ...
 declare precedence: AspectJMLRac_*, *;
  ...
  before (final cmdUi.menu.AbstractMenu object$rac) :
     ...
     this(object$rac) {
         String invErrorMsg = "@pre <File \"AbstractMenu.java\"> regarding code at \nFile \"AbstractMenu.java\"\nnon_null for field 'con' <File \"cmdUi.menu.AbstractMenu.java\", line 9, character 34 (cmdUi.menu.AbstractMenu.java:9)>\nnon_null for field 'parent' <File \"cmdUi.menu.AbstractMenu.java\", line 10, character 39 (cmdUi.menu.AbstractMenu.java:10)>\n\nnon_null for field 'sc' <File \"cmdUi.menu.AbstractMenu.java\", line 12, character 30 (cmdUi.menu.AbstractMenu.java:12)>";
         String evalErrorMsg = "Invalid expression in \"@pre <File \"AbstractMenu.java\"> regarding code at \nFile \"AbstractMenu.java\"\nnon_null for field 'con' <File \"cmdUi.menu.AbstractMenu.java\", line 9, character 34 (cmdUi.menu.AbstractMenu.java:9)>\nnon_null for field 'parent' <File \"cmdUi.menu.AbstractMenu.java\", line 10, character 39 (cmdUi.menu.AbstractMenu.java:10)>\n\nnon_null for field 'sc' <File \"cmdUi.menu.AbstractMenu.java\", line 12, character 30 (cmdUi.menu.AbstractMenu.java:12)>\nCaused by: ";
         boolean rac$b = true;
         try {
          rac$b = ((object$rac.sc != null) && ((object$rac.parent != null) && (object$rac.con != null)));
         } catch (JMLNonExecutableException rac$nonExec) {
            rac$b = false;
         } catch (Throwable rac$cause) {
            if(rac$cause instanceof JMLAssertionError) {
  ...
  before (final cmdUi.menu.AbstractMenu object$rac, final controller.Controller con, final int options, final cmdUi.menu.AbstractMenu parent) :
     ...
     this(object$rac) && args(con, options, parent) {
       String preErrorMsg = "by method cmdUi.menu.AbstractMenu.<init> regarding code at \nFile \"cmdUi.menu.AbstractMenu.java\""+", when \n"+"\t\'con\' is "+con+"\n\t\'parent\' is "+parent+ ", when \n"+"\t\'con\' is "+con+"\n\t\'parent\' is "+parent;
       String evalErrorMsg = "Invalid expression in \"cmdUi.menu.AbstractMenu.java\"\nCaused by: ";
       boolean rac$b = true;
       try {
