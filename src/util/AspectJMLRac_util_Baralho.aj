...
privileged aspect AspectJMLRac_util_Baralho775c5d96_604d_4b31_9c56_a0607bc25748 {
 ...
 declare precedence: AspectJMLRac_*, *;
  ...
  after (final util.Baralho object$rac) returning (final java.util.ArrayList rac$result) :
     (execution(java.util.ArrayList util.Baralho.puxarTodasAsCartas())) && this(object$rac) {
       ...
       String evalErrorMsg = "";
       boolean rac$b = true;
         nPostErrorMsg =  "by method util.Baralho.puxarTodasAsCartas regarding specifications at \nFile \"util.Baralho.java\", line 45, character 39 (util.Baralho.java:45), and \nby method util.Baralho.puxarTodasAsCartas regarding code at \nFile \"util.Baralho.java\", line 55 (util.Baralho.java:55)";
         evalErrorMsg = "Invalid expression in \"util.Baralho.java\" by method util.Baralho.puxarTodasAsCartas regarding specifications at \nline 45, character 39 (util.Baralho.java:45)\nCaused by: ";
       if (true){
         try {
           rac$b = ((rac$result != null) && (object$rac.cartas.size() == 0));
         } catch (JMLNonExecutableException rac$nonExec) {
            rac$b = false;
         } catch (Throwable rac$cause) {
            if(rac$cause instanceof JMLAssertionError) {
  ...
  before (final util.Baralho object$rac) :
     ...
     this(object$rac) {
         String invErrorMsg = "@pre <File \"Baralho.java\"> regarding code at \nFile \"Baralho.java\"\nnon_null for field 'cartas' <File \"util.Baralho.java\", line 9, character 54 (util.Baralho.java:9)>";
   ...
   * method puxarTodasAsCartas. */
  before (final util.Baralho object$rac) :
     (execution(java.util.ArrayList util.Baralho.puxarTodasAsCartas())) && 
     this(object$rac) {
       String preErrorMsg = "by method util.Baralho.puxarTodasAsCartas regarding specifications at \nFile \"util.Baralho.java\", [spec-case]: line 44, character 23 (util.Baralho.java:44), and \nby method util.Baralho.puxarTodasAsCartas regarding code at \nFile \"util.Baralho.java\", line 55 (util.Baralho.java:55)";
       String evalErrorMsg = "Invalid expression in \"util.Baralho.java\" by method util.Baralho.puxarTodasAsCartas regarding specifications at \n[spec-case]: line 44, character 23 (util.Baralho.java:44)\nCaused by: ";
       boolean rac$b = true;
       try {
        rac$b = (true);
       } catch (JMLNonExecutableException rac$nonExec) {
       ...
       JMLChecker.checkPrecondition(rac$b, canThrow, preErrorMsg, -1, object$rac.getClass().getName() + "@" + Integer.toHexString(System.identityHashCode(object$rac))+".puxarTodasAsCartas()");
  ...
  public static aspect UtilPreconditionChecking_Baralho{
    before(): (execution( * util.Baralho..*+.*(..))
            || execution(util.Baralho..*+.new(..))
            || execution( * util.Baralho+.*(..))
            || execution(util.Baralho+.new(..))){
